...
// IDEA: Для score условия сделать target либо числом, либо объектом {"min": 0, "max": 99}. Если задано числом -
//  ожидается точное значение, если только min - диапазон без верхней границы, без max - без нижней границы и оба есть -
//  конкретный диапазон значений. Нужно придумать как делать progressbar тогда
