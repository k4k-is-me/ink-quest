...
Все команды требуют уровень оператора **2+**. Полный справочник с примерами — в `docs/ДОКУМЕНТАЦИЯ/СПРАВОЧНИК КОМАНД.md`.
...
Полная пользовательская документация находится в `docs/ДОКУМЕНТАЦИЯ/`. Архитектурные решения — в `docs/Решения/`.