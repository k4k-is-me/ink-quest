...
import k4k.inkquest.infra.gamerules.ModGameRules;
import k4k.inkquest.infra.items.ModItems;
import k4k.inkquest.infra.sounds.ModSounds;
import k4k.inkquest.infra.handlers.QuestBookSyncHandler;
import k4k.inkquest.infra.handlers.QuestHudSyncHandler;
import k4k.inkquest.infra.handlers.QuestLifecycleFunctionExecutor;
import k4k.inkquest.infra.requests.GetQuestDetailsClientRequest;
import k4k.inkquest.infra.command_argument_types.CompletionLevelArgumentType;
import k4k.inkquest.infra.command_argument_types.CompletionStatusArgumentType;
import k4k.inkquest.infra.command_argument_types.QuestGeneralStatusArgumentType;
import k4k.inkquest.infra.command_argument_types.TaskGeneralStatusArgumentType;
import k4k.inkquest.infra.commands.ExecuteCommandExtension;
import k4k.inkquest.infra.loaders.QuestingPersistentStateAdapter;
import k4k.inkquest.domain.enums.CompletionStatus;
import k4k.inkquest.infra.networking.QuestBookOpenAtQuestS2CPacket;
...
import k4k.inkquest.infra.loaders.QuestResourceLoader;
import k4k.inkquest.infra.commands.QuestCommand;
...
public class TravelcoreQuesting implements ModInitializer {
	public static final String MOD_ID = "inkquest";
	...
	public void onInitialize() {
		...
		ServerPlayNetworking.registerGlobalReceiver(QuestBookOpenRequestC2SPacket.TYPE, (packet, player, sender) -> {
			if (ModGameRules.canPlayerOpenQuestBook(player)) {
				...
				player.sendMessage(
						Text.translatable("inkquest.quest_book.error.no_book_in_inventory"),
						true
				);
			}
		});
	...
	private void registerQuestProgressUpdate() {
		ServerTickEvents.END_SERVER_TICK.register(server -> {
			var questManager = ((ServerQuestManagerContainer) server).inkquest$getQuestManager();
