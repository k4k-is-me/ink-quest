 ...
 *
 * <p>{@code successTarget}/{@code failureTarget} присутствуют только когда target > 1
 * (прогресс-бар показывается). {@code null} означает условие без прогресс-бара.
 *
 * <p>{@code currentSuccessProgress}/{@code currentFailureProgress} — текущие значения
 * для активных задач; {@code null} для завершённых или если прогресс-бар не показывается.
 *
