...
public class ClientRequests {
    private static final Map<Class<?>, ClientRequest<?, ?>> requestMapping = new HashMap<>();
    ...
    public static <Rq extends IRequest<Rs>, Rs extends IResponse> void register(
            ...
            ClientRequest<Rq, Rs> requestSender
    ) {
    ...
    public static <Rq extends IRequest<Rs>, Rs extends IResponse> CompletableFuture<Rs> send(Rq request) {
        ...
        var typedSender = (ClientRequest<Rq, Rs>) sender;
        return typedSender.send(request);
    }
}
