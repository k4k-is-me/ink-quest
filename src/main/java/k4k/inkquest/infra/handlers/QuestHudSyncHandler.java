...
import k4k.inkquest.infra.networking.HudQuestRemoveS2CPacket;
import k4k.inkquest.infra.networking.HudSetQuestStageS2CPacket;
import k4k.inkquest.infra.networking.HudTaskAddS2CPacket;
import k4k.inkquest.infra.networking.HudTaskCompleteS2CPacket;
import k4k.inkquest.infra.networking.HudTaskPinS2CPacket;
import k4k.inkquest.infra.networking.HudTaskRemoveS2CPacket;
import k4k.inkquest.infra.networking.HudTaskSetProgressS2CPacket;
...
import k4k.inkquest.questing.events.QuestEvents;
...
public class QuestHudSyncHandler {
    ...
    public static void register() {
        ...
        QuestProgressEvents.TASK_LOADED.register((taskEntry, player, stageChanged) -> {
            ...
            ServerPlayNetworking.send(player, new HudTaskAddS2CPacket(
                    questId,
                    taskId,
                    HudTasks.fromTask(task, successTarget, failureTarget, null, null, null)
            ));
        });
     ...
     * {@code pinnedTaskId} упакован в {@link k4k.inkquest.questing.models.HudQuest}.
     *
    ...
    private static void sendQuestStagePacket(
        ...
        for (var taskId : entry.quest().getStage(stage)) {
            ...
            tasks.put(taskId, HudTasks.fromTask(task, successTarget, failureTarget, currentSuccessProgress, currentFailureProgress, completionStatus));
        }
