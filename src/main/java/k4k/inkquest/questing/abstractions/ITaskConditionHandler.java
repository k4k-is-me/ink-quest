...
public interface ITaskConditionHandler<T extends ITaskCondition> {
     ...
     *
     * <p>Для бинарных условий возвращает 1 (прогресс-бар не показывается, т.к. target == 1).
     * Для условий с реальным диапазоном — фактическую цель, которая может зависеть от {@code context}
